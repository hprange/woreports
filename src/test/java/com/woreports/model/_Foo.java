// $LastChangedRevision$ DO NOT EDIT.  Make changes to Foo.java instead.
...
public abstract class _Foo extends  EOGenericRecord {
  ...
  public com.woreports.model.FooRelated related() {
    return (com.woreports.model.FooRelated)storedValueForKey("related");
  }

  public void setRelatedRelationship(com.woreports.model.FooRelated value) {
    if (_Foo.LOG.isDebugEnabled()) {
      _Foo.LOG.debug("updating related from " + related() + " to " + value);
    }
    if (value == null) {
    	com.woreports.model.FooRelated oldValue = related();
    	if (oldValue != null) {
